...
(cl:defmethod cl:initialize-instance :after ((m <serial>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'serial)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serial_cmd-msg:<serial> is deprecated: use serial_cmd-msg:serial instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <serial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_cmd-msg:header-val is deprecated.  Use serial_cmd-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <serial>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serial_cmd-msg:cmd-val is deprecated.  Use serial_cmd-msg:cmd instead.")
  (cmd m))
